	...
	public void setMainApp(MainApp mainApp) {
		...
		Omaha.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				PokerTableController.setGameRule(GameRuleBLL.getGameRule("Omaha"));
			}
		});
		Texas.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				PokerTableController.setGameRule(GameRuleBLL.getGameRule("TexasHoldEm"));
			}
		});
		...
		FCD.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				PokerTableController.setGameRule(GameRuleBLL.getGameRule("FiveCardDraw"));
			}
		});
		...
		SCD.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				PokerTableController.setGameRule(GameRuleBLL.getGameRule("SevenCardDraw"));
			}
		});
		...
		oneJoker.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				PokerTableController.setGameRule(GameRuleBLL.getGameRule("FiveStudOneJoker"));
			}
		});
		...
		twoJoker.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				PokerTableController.setGameRule(GameRuleBLL.getGameRule("FiveStudTwoJoker"));
			}
		});
